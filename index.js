...
(function() {
  var Beat, MAX_GLOBAL_HUE, MIN_GLOBAL_HUE, Nebula, NebulaStar, ShootingStar, StarParticle, audioEl, fft, globalHue, globalHueModifier, jsonLoaded, nebulae, r, renderBars, renderWaveform, scheduleBars, scheduleBeats, scheduleSections, selectSong, shootingStars, theBeat, theNebula, triggerBeat,
  ...
  ShootingStar = (function() {
    function ShootingStar(maxAge) {
      ...
      this.velX = -this.velY;
      this.alpha = 40;
      this.diameter = ~~(Math.random() * (12 - 7) + 7);
      this.starParticles = [];
      for (i = j = 1; j <= 50; i = ++j) {
